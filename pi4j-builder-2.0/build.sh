...
# **********************************************************************
# ORGANIZATION  :  Pi4J
# PROJECT       :  Pi4J :: Build Docker Image for Pi4J v2.0 Builder
# FILENAME      :  build.sh
#
...
docker buildx create --use --name pi4j-builder-$VERSION || true;
