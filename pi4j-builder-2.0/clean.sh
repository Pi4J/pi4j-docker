...
# **********************************************************************
# ORGANIZATION  :  Pi4J
# PROJECT       :  Pi4J :: Clean Docker Image for Pi4J Builder (2.0)
# FILENAME      :  clean.sh
#
...
echo
echo "**********************************************************************"
echo "* CLEANING Pi4J BUILDER v$VERSION (DOCKER IMAGE)                          *"
echo "**********************************************************************"
echo

# remove the builder instance
docker buildx rm pi4j-builder-$VERSION || true

# remove any containers from local Docker registry
docker rmi --force pi4j/pi4j-builder:$VERSION
docker rmi --force pi4j/pi4j-builder:latest
