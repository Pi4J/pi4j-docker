...
# **********************************************************************
# ORGANIZATION  :  Pi4J
# PROJECT       :  Pi4J :: Build Docker Image for Pi4J Native Builder
# FILENAME      :  build.sh
#
...
echo
echo "**********************************************************************"
echo "* BUILDING Pi4J NATIVE BUILDER (DOCKER IMAGE)                        *"
echo "**********************************************************************"
echo
...
docker buildx build \
  ...
  --tag pi4j/pi4j-builder-native:1.4 \
  --tag pi4j/pi4j-builder-native:$VERSION \
  --tag pi4j/pi4j-builder-native:latest . $@

# remove the builder instance when completed
#docker buildx rm pi4j-builder-native:$VERSION
#docker buildx rm pi4j-builder-native:1.4
#docker buildx rm pi4j-builder-native:latest