...
# **********************************************************************
# ORGANIZATION  :  Pi4J
# PROJECT       :  Pi4J :: Clean Docker Image for Pi4J Base Builder
# FILENAME      :  clean.sh
#
...
echo
echo "**********************************************************************"
echo "* CLEANING Pi4J BASE BUILDER (DOCKER IMAGE)                          *"
echo "**********************************************************************"
echo

# remove the builder instance
docker buildx rm pi4j-builder-base || true

# remove any containers from local Docker registry
docker rmi --force pi4j/pi4j-builder-base:$VERSION
docker rmi --force pi4j/pi4j-builder-base:latest
